...
const products = [
  ...
  },
  {
    ...
    price: 1500,
    image:
      "https://5.imimg.com/data5/SELLER/Default/2022/9/VE/TN/BV/208914/bioclean-septic-tank-cleaner-microbial-culture-for-odour-removal-500x500.jpg",
  ...
  },
  {
    ...
    description:
      "An advanced septic treatment solution that enhances waste digestion and prevents system clogs for long-term maintenance.",
  },
]
...
const ShopPage = () => {
  ...
  const styles = {
    ...
    checkoutButton: {
      backgroundColor: "rgba(64, 224, 208, 0.8)", // Turquoise color with some transparency
      color: "white",
      border: "none",
      padding: "1rem 2rem",
      borderRadius: "4px",
      ...
      marginTop: "1rem",
      width: "100%",
      backdropFilter: "blur(5px)", // This adds the blurry effect
              ...
              <div key={item.id} style={styles.cartItem}>
                ...
                <div style={styles.cartItemDetails}>
                  ...
                  <div style={styles.cartItemQuantity}>
                    <button style={styles.quantityButton} onClick={() => decrementQuantity(item.id)}>
                      -
                    </button>
                    <span style={styles.quantityDisplay}>{item.quantity}</span>
                    <button style={styles.quantityButton} onClick={() => incrementQuantity(item.id)}>
                      +
                    </button>
                ...
                <div style={{ fontWeight: "bold", marginLeft: "auto" }}>{formatPrice(item.price * item.quantity)}</div>
              </div>
            ))}

            <div style={styles.cartTotal}>Total: {formatPrice(calculateTotal())}</div>
        ...
        wishlist.map((item) => (
          <div key={item.id} style={styles.wishlistItem}>
            ...
            <div style={styles.wishlistItemButtons}>
              <button style={{ ...styles.wishlistButton, ...styles.moveToCartButton }} onClick={() => moveToCart(item)}>
                Move to Cart
              </button>
              <button
                    ...
                    >
                      ...
                      <div style={styles.cardContent}>
                        ...
                        <div style={styles.buttonContainer}>
                          <button onClick={() => addToCart(product)} style={{ ...styles.button, ...styles.cartButton }}>
                            Add to Cart
                          </button>
                          <button
